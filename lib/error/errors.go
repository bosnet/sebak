...
var (
	...
	ErrorBlockAccountDoesNotExists        = NewError(100, "account does not exists in block")
	ErrorBlockAccountAlreadyExists        = NewError(100, "account already exists in block")
	ErrorAccountBalanceUnderZero          = NewError(100, "account balance will be under zero")
)
