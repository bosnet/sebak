...
func (checker *NodeRunnerHandleTransactionChecker) isInValidTransactions(hash string) (found bool) {
	_, found = sebakcommon.InStringArray(checker.Ballot.ValidTransactions(), hash)
	return
}
