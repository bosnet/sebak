...
const GetMissingTransactionByHashHandlerPattern = "/missingtxs/{txid}"

func GetMissingTransactionByHashHandler(storage *sebakstorage.LevelDBBackend) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
