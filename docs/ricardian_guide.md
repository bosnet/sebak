...
The amount of issuance: 160833600 BOScoin
...
Detailed description:
    ...
    - Membership reward will be distributed in accordance with the following rules: 
        ...
        - From the second to the thirteenth (the second to the last) distribution of Membership reward will include 483,840 blocks (approximately 28 days) of rewards.
...
Limitations on Warranties:
    ...
    - BlockchainOS Inc. shall not be liable for any failure, restrictions on service or 
      ...
      The forfeiture does not include any damage compensation.Title: Membership Reward PF
